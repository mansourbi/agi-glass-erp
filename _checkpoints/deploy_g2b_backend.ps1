# ============================================================================
#  BLOCK G-2b backend - order-level pricing write endpoints on routes\pricing2.js
#  (profile override + discount via order_price_choice; manual charges via
#  order_extra_charges). Preview tables only - live billing untouched.
#  Route-only (no DB migration). RUN AS ADMINISTRATOR.
# ============================================================================
...
# robust restart (no DB touch, so safe)
...
Write-Host 'G-2b backend live. Next: G-2b frontend (the Pricing tab UI).'
