# deploy_r2_batch2b.ps1  -- R-2 batch 2b: Deliveries + Labels/Tracking (worker-shared, any-of)
...
$ok = ($txt -match "deliveries\.finalize") -and ($txt -match "cutting\.labels") -and ($txt -match "tracking\.update")
Write-Host ("batch-2b markers present: " + $ok)
...
Write-Host "Batch 2b deployed (Deliveries + Labels/Tracking (worker-shared, any-of))."
